...
## About this project
This project was developed as a final semester project for MIT's fall 2024 class, 1.S980 (ACT4E, Applied Category Theory for Engineering Design). It uses a codesign framework and MCDPL code to design medical residency programs. We study this problem because today’s residency programs are no longer meeting the needs of a fast-paced, ever-evolving medical landscape. The framework aims to design medical residency within 1 medical specialty and on the timescale of 1 year. 
